...
private:
  bool loadCartridge(string&, string&, uint8_t *&data, unsigned &size);
  bool loadMemory(const char*, const char*, unsigned);
  bool saveMemory(const char*, const char*, unsigned);
